...
REM Versao: 2.3.0
REM Data: 03/11/2025
REM Mudancas: Logo atualizado, Checkbox audio ativado, texto removido, botao Sobre adicionado
...
echo  1. Verifique versao na SplashScreen (deve mostrar 2.3.0)
echo  2. Verifique logo na HomeScreen (novo icone)
echo  3. Abra Historico e Ferramentas
echo  4. Verifique checkbox "Resposta em Audio" (deve estar ATIVADO)
echo  5. Verifique botao "Sobre" (deve mostrar SplashScreen)
echo  6. Verifique se tem 11 tarefas pre-instaladas
echo.
pause
